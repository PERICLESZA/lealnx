...
import { useAuth } from '../context/Autocontext'; // Importe o contexto de autenticação
import { AuthProvider } from '../context/Autocontext'; // Importe o contexto de autenticação
...
export default function Home() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setUser(username); // Definir o usuário como string
        ...
        setUserNameDisplay('');
        setUser(null); // Define como null em caso de falha
  ...
  const handleMenuChange = (e) => {
    ...
    if (selectedOption === "Logout") {
      ...
      router.push('/city'); // Redireciona para a página que renderiza o componente City
    }
  };
